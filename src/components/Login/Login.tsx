...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-[calc(100vh-120px)] bg-gradient-to-b from-white to-gray-50 px-6 py-16 dark:from-gray-900 dark:to-gray-950">
        ...
        <div className="flex items-center justify-center">
          <div className="w-full max-w-md rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
            ...
            {/* <div className="mt-6 grid grid-cols-2 gap-3">
              <button className="rounded-xl border border-gray-300 px-4 py-2 text-sm dark:border-gray-700">Google</button>
              <button className="rounded-xl border border-gray-300 px-4 py-2 text-sm dark:border-gray-700">Microsoft</button>
            </div> */}
          </div>
        </div>
      </div>
